...
void TutorialMsgCallback(const tutorial_msgs::TutorialMsg::ConstPtr& tutorial_msg)
{
 ...
 ROS_INFO("tutorial_msg.UInt32 = %lu", tutorial_msg->UInt32);
 ROS_INFO("tutorial_msg.Int64 = %lld", tutorial_msg->Int64); 
 ROS_INFO("tutorial_msg.UInt64 = %llu", tutorial_msg->UInt64);
...
int main(int argc, char **argv)
{
 ...
 subscriber_tutorial_msg = n.subscribe("tutorial_subscribe_msg", 1000, TutorialMsgCallback);
